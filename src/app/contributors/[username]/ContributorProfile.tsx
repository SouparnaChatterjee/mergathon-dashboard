...
export default function ContributorProfile({ username }: { username: string }) {
  ...
  const pieData = [
    ...
    { name: "Reviews", value: contributor.prsReviewed, color: "var(--accent-violet)" },
  ...
  const getFeedItemStyle = (type: string) => {
    switch (type) {
      ...
      case "pr_reviewed":
        return { color: "var(--accent-violet)", bg: "rgba(139, 92, 246, 0.1)", icon: MessageSquare, label: "Reviewed PR" };
      case "issue_closed":
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div className="card" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 12px", background: "var(--bg-tertiary)", borderRadius: "var(--radius-md)" }}>
                <span style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "13px", color: "var(--text-secondary)", fontWeight: 500 }}>
                  <MessageSquare size={16} style={{ color: "var(--accent-violet)" }} />
                  <span>PR Reviews</span>
                </span>
                <span style={{ fontWeight: 700 }}>{contributor.prsReviewed}</span>
              </div>
